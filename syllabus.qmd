...
-   CS 506, Spring 2026, 3 units
-   Section 001: TuTh 12:45PM - 2:00PM, SICCS 223
-   Prerequisite: Graduate status
-   Mode of Instruction: Face-to-face (in person)
-   Instructor's Name & Contact:
    -   Crystal Hepp (crystal.hepp\@nau.edu)
        -   Room 315, SICCS (Building 90, second floor)
...
I have compiled a [course website](https://marctollis.github.io/cs506-book/) that has supplemental text and coded examples that we will walk through in class. This website  is required reading. There will be other required reading material.
...
-   All **Canvas-based assignments are due Sunday by 11:59PM** the week they are assigned (except the Mini Hackathon).
